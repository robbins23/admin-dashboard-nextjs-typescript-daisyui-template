...
function GettingStartedContent(): React.JSX.Element {
  return (
    <>
      <article className="prose">
        ...
        <p>
          ...
          and react js. With the help of Dasisy UI, it comes with{" "}
          ...
          and configured it for API calls and state management.
        </p>
        <p>
        ...
        <ul>
          <li>
            <a href="https://reactjs.org/" target="_blank">React JS v18.2.0</a>
          </li>
          <li>
          ...
          <li>
            <a href="https://daisyui.com/" target="_blank">Daisy UI v4.4.19</a>
          </li>
          <li>
        ...
        <p>
          ...
          >
            Daisy UI
          </a>, a popular free and opensource tailwind component library has
          been used for this template. It has a rich collection of components,
