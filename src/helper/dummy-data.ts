  ...
  BILLS: [
    {
      ...
      status: "Pending",
      generatedOn: moment(new Date()).add(-30 * 1, "days").format(
        "DD MMM YYYY",
      ),
      paidOn: "-",
    },
    {
      ...
      description: "Product usages",
      status: "Pending",
      generatedOn: moment(new Date()).add(-30 * 2, "days").format(
        "DD MMM YYYY",
      ),
      paidOn: "-",
    },
    {
      ...
      description: "Product usages",
      status: "Paid",
      generatedOn: moment(new Date()).add(-30 * 3, "days").format(
        "DD MMM YYYY",
      ),
    ...
    },
    {
      ...
      description: "Product usages",
      status: "Paid",
      generatedOn: moment(new Date()).add(-30 * 4, "days").format(
        "DD MMM YYYY",
      ),
    ...
    },
    {
      ...
      description: "Product usages",
      status: "Paid",
      generatedOn: moment(new Date()).add(-30 * 5, "days").format(
        "DD MMM YYYY",
      ),
    ...
    },
    {
      ...
      description: "Product usages",
      status: "Paid",
      generatedOn: moment(new Date()).add(-30 * 6, "days").format(
        "DD MMM YYYY",
      ),
    ...
    },
    {
      ...
      description: "Product usages",
      status: "Paid",
      generatedOn: moment(new Date()).add(-30 * 7, "days").format(
        "DD MMM YYYY",
      ),
    ...
    },
    {
      ...
      description: "Product usages",
      status: "Paid",
      generatedOn: moment(new Date()).add(-30 * 8, "days").format(
        "DD MMM YYYY",
      ),
